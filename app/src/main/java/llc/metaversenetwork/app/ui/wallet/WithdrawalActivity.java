 ...
 * 币种提现
 */
public class WithdrawalActivity extends BaseTitleActivity<ActivityWithdrawalBinding> implements OnHolderClickListener<WalletAdapter> {
    // USDT:4
    // MNC:173
...
//    }
    ...
    protected void onRightTitleClick() {
        ViewUtil.gotoActivity(this, CurrencyWithdrawalRecordActivity.class);
    }
}